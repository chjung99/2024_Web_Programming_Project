...
<script src="https://apis.google.com/js/platform.js" async defer></script>
    ...
    */
    ...
    // chjung
    // Update the hidden input with the high score and display the form
    const highScoreInput = document.getElementById("highScoreInput");
    highScoreInput.value = this.highestScore;
    
    const shareScoreForm = document.getElementById("shareScoreForm");
    shareScoreForm.style.display = 'block';
    ...
    const shareScoreForm = document.getElementById("shareScoreForm");
    shareScoreForm.style.display = 'none';
    ...
    */
    ...
    var numericHighScore = parseInt(highScoreStr, 10);

    // Print the integer high score to the console
    console.log('High Score:', numericHighScore);
    sessionStorage.setItem('highScore', numericHighScore);

    var cookiename = "highestScore";
    var expires = "";
    ...
    document.cookie = cookiename + "=" + (parseInt(numericHighScore, 10) || "") + expires + "; path=/";

    var xhr = new XMLHttpRequest();
    xhr.open("GET", "record.php", true); // 요청 설정
    xhr.onreadystatechange = function () {
        if (xhr.readyState == 4 && xhr.status == 200) {
            // 요청이 완료되고 성공했을 때
            console.log(xhr.responseText); // PHP에서 반환된 응답 처리
        }
    };
    xhr.send(); // 요청 전송
   ...
   found in the LICENSE file. */
   body {
    background-image: url('/practice/minor-project/dinoback.png');
    background-size: cover;
    font-family: 'Press Start 2P', cursive; /* 레트로 게임 폰트 */
    color: #ffffff;
    text-align: center;
    padding-top: 5vh;
    font-size: 2vw; /* 폰트 크기를 뷰포트 너비의 2%로 설정 */
}
a {
  color: #585858;
}
...
<div id="main-frame-error" class="interstitial-wrapper" jstcache="0">
    <div class="onlyforchrome" style="font-size: 30px;text-align: center;font-family: 'Press Start 2P', cursive;">Running T-Rex</div>
    <!-- chjung removed -->
  ...
  <!-- chjung -->
  <div>
    <button class="retro-button" id="home_button" onclick="window.location.href='/practice/minor-project/home.php'"><</button>
  </div>
  <script type="text/javascript">
...
<!-- chjung -->
<form id="shareScoreForm" action="share.html" method="POST" style="display:none;">
  <input type="hidden" name="highScore" id="highScoreInput">
  <div class="flex-center2">
  <button class="retro-button" type="submit" id="shareScoreButton">Share Your Score</button>
  </div>
</form>
<!-- chjung -->
...
<div class="flex-center">
            <button class="retro-button" id="cam_button" type="button" onclick="init()">Cam Start</button>
</div>
<!-- <button class="retro-button" id="cam_button" type="button" onclick="init()">Cam Start</button> -->
...
<!-- <script src="https://cdn.jsdelivr.net/npm/@tensorflow/tfjs@1.3.1/dist/tf.min.js" async defer></script>
<script src="https://cdn.jsdelivr.net/npm/@teachablemachine/pose@0.8/dist/teachablemachine-pose.min.js" async defer></script> -->
<script type="text/javascript" async defer>
    // More API functions here:
    // https://github.com/googlecreativelab/teachablemachine-community/tree/master/libraries/pose

    // the link to your model provided by Teachable Machine export panel
    const URL = "https://teachablemachine.withgoogle.com/models/IVlu8H-Hc/";
    ...
    async function predict() {
        ...
        for (let i = 0; i < maxPredictions; i++) {
            var cls = prediction[i].className;
            if (cls == "run"){
              cls = "jump";
            }
            else{
              ...
              cls + ": " + prediction[i].probability.toFixed(2);
            // const classPrediction =
